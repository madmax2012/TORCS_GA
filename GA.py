    ...
    def __init__(self, rep_length, popsize, sp, mut, fitfun, maxgen, cross, nr_processes, run_id , path, onlyThebest, runval):
        ...
        if self.onlyTheBest == 0:
            for i in range(self.popsize):
                    ...
                    #new:
                    self.cars.append(individual.individual(154.897575174, -0.1, 0.310951452412, 0.618095446024, 103.513962623, 1.01137784125, 0.271561863594, 33.9671867449, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    '''middlepop
        ...
        if self.onlyTheBest == 1:
            ...
            #run: 32 generation: 72 fittest at: 0 its fitness: 867.768 aal_forza_eroad_street_alpine1_wheel2   survives spring!!
            self.cars.append(individual.individual('154.897575174', '0', '0.310951452412', '0.816044271632', '94.0126932938', '0.662295736567', '0.271561863594', '30.7883515863', '0.135023495875', '6565.8878', '0.829675710924', '71.9746111702', '50.2293068554'))
                                    #it's values:  ['154.897575174', '-0.1', '0.310951452412', '0.618095446024', '103.513962623', '1.01137784125', '0.271561863594', '33.9671867449', '0.0215211462875', '6565.8878', '0.829675710924', '71.9746111702', '50.2293068554']
