    ...
    def __init__(self, rep_length, popsize, sp, mut, fitfun, maxgen, cross, nr_processes, run_id , path, onlyThebest, runval):
        ...
        if self.onlyTheBest == 0:
            for i in range(self.popsize/10):
                    ...
                    self.cars.append(individual.individual(154.897575174, -0.19, 0.179856307171, 0.779904990626, 93.0625663607, 1.01137784125, 0.271561863594, 33.9671867449, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(154.897575174, -0.01, 0.284863518509, 0.618095446024, 102.468822997, 0.810240057125, 0.0299651095111, 27.3234212634, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(210.712756409, 0, 0.634806649722, 1.21960966533, 86.2476522441, 0.662295736567, 0.271561863594, 22.883059043, 0.299740819726, 5968.898, 0.646708139832, 64.0203785526, random.uniform(50,100)))
