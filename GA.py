...
class RunGA():
    def __init__(self, rep_length, popsize, sp, mut, fitfun, maxgen, cross, nr_processes, run_id , path, onlyThebest, runval):
        ...
        if self.onlyTheBest == 0:
            for i in range(self.popsize/10):
                    '''OLD
                    ...
                    self.cars.append(individual.individual(208.595628845, 0.21, 0.0618706764536, 1.19741356867, 56.8213986236, 0.00149883632855, 0.384730869455, 38.2448785016, 0.286743411529, 8025.1962, 1.01264328202, 71.9746111702, random.uniform(50,100)))
                    self.cars.append(individual.individual(210.712756409, 0, 0.634806649722, 1.21960966533, 86.2476522441, 0.662295736567, 0.271561863594, 22.883059043, 0.299740819726, 5968.898, 0.646708139832, 64.0203785526, random.uniform(50,100)))
                    #.5 worse than below on debugline_wheel2_aal_forza_eroad_street_alpine1. self.cars.append(individual.individual(208.595628845, 0, 0.337569077045, 0.834388153164, 86.2476522441, 0.387674878176, 0.538589854949, 20.7118718573, 0.169766737753, 6632.22, 0.829675710924, 71.9746111702, random.uniform(50,100)))
                    self.cars.append(individual.individual(208.595628845, 0, 0.324193386274, 0.834388153164, 77.5228870197, 0.387674878176, 0.384730869454, 20.7118718573, 0.169766737753, 6632.22, 0.829675710924, 71.9746111702, random.uniform(50,100)))
                    '''
                    ...
                    ##best for now
                    self.cars.append(individual.individual(154.897575174, -0.01, 0.179856307171, 0.618095446024, 93.0625663607, 0.810240057125, 0.271561863594, 24.4910791371, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    self.cars.append(individual.individual(154.897575174, -0.01, 0.179856307171, 0.618095446024, 93.0625663607, 0.810240057125, 0.271561863594, 24.4910791371, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    self.cars.append(individual.individual(154.897575174, -0.01, 0.179856307171, 0.618095446024, 93.0625663607, 0.810240057125, 0.271561863594, 24.4910791371, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    self.cars.append(individual.individual(154.897575174, -0.01, 0.179856307171, 0.618095446024, 93.0625663607, 0.810240057125, 0.271561863594, 24.4910791371, 0.0215211462875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    self.cars.append(individual.individual(170.487332692, 0, 0.0834309524066, 0.816044271632, 68.9638923345, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    self.cars.append(individual.individual(173.969220173, 0, 0.651319848204, 0.834388153164, 87.1289416607, 0.387674878176, 0.427117692025, 25.8047800707, 0.193517740795, 6029.2, 0.512128686714, 71.9746111702, 55, random.uniform(5,15)))
                    self.cars.append(individual.individual(139.307817657, 0, 0.191774047647, 0.816044271632, 84.5114239644, 0.662295736567, 0.412846515105, 30.7883515863, 0.0215211462877, 6565.8878, 0.829675710924, 71.9746111702, 55.352237541, random.uniform(5,15)))
                    self.cars.append(individual.individual(154.897575174, 0, 0.310951452412, 0.816044271632, 94.0126932938, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    self.cars.append(individual.individual(170.487332692, 0, 0.0834309524066, 0.816044271632, 68.9638923345, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554, random.uniform(5,15)))
                    '''middlepop
                    self.cars.append(individual.individual(154.897575174, 0.1979, 0.310951452412, 0.816044271632, 94.0126932938, 1.01137784125, 0.271561863594, 33.9671867449, 0.135023495875, 5909.19902, 0.829675710924, 71.9746111702, 55.352237541))
                    self.cars.append(individual.individual(154.897575174, 0, 0.310951452412, 0.816044271632, 94.0126932938, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(154.897575174, 0, 0.310951452412, 0.816044271632, 94.0126932938, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(154.897575174, 0, 0.310951452412, 0.816044271632, 94.0126932938, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(154.897575174, 0, 0.310951452412, 0.816044271632, 94.0126932938, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 58.1094350479, 50.2293068554))
                    self.cars.append(individual.individual(154.897575174, 0.331, 0.0834309524066, 0.997648698796, 85.3751757217, 1.01137784125, 0.271561863594, 33.9671867449, 0.135023495875, 5909.19902, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(139.307817657, 0, 0.191774047647, 0.816044271632, 84.5114239644, 0.662295736567, 0.412846515105, 30.7883515863, 0.0215211462877, 6565.8878, 0.829675710924, 71.9746111702, 55.352237541))
                    self.cars.append(individual.individual(154.897575174, 0.331, 0.310951452412, 0.816044271632, 94.0126932938, 0.810240057121, 0.271561863594, 33.9671867449, 0.135023495875, 5909.19902, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(153.338599422, 0.1979, -0.024912142834, 0.816044271632, 76.7376581495, 0.828525310224, 0.692448840444, 33.9671867449, 0.0215211462877, 5909.19902, 0.646708139832, 64.6771500532, 55.352237541))
                    self.cars.append(individual.individual(170.487332692, 0, 0.0834309524066, 0.816044271632, 68.9638923345, 0.662295736567, 0.271561863594, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(139.307817657, 0.1, 0.0834309524066, 0.816044271632, 85.3751757217, 0.662295736567, 0.398718049954, 24.7485647849, 0.0215211462877, 6565.8878, 0.829675710924, 71.9746111702, 45.1063761699))
                    self.cars.append(individual.individual(154.897575174, 0, 0.0834309524066, 0.816044271632, 85.3751757217, 0.662295736567, 0.271561863594, 33.9671867449, 0.0215211462877, 6565.8878, 0.646708139832, 71.9746111702, 55.352237541))
                    self.cars.append(individual.individual(154.897575174, -0.1, 0.0725966428826, 0.816044271632, 94.0126932938, 0.662295736567, 0.271561863594, 30.7883515863, 0.0215211462877, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(139.307817657, 0.331, 0.0834309524066, 0.816044271632, 76.7376581495, 1.01137784125, 0.692448840444, 33.9671867449, 0.0215211462877, 5909.19902, 0.829675710924, 71.9746111702, 49.7170137869))
                    self.cars.append(individual.individual(154.897575174, 0, -0.122420928551, 0.816044271632, 94.0126932938, 0.662295736567, 0.554131166615, 30.7883515863, 0.135023495875, 6565.8878, 0.829675710924, 71.9746111702, 50.2293068554))
                    self.cars.append(individual.individual(153.338599422, 0, 0.191774047647, 0.797883828916, 68.9638923345, 0.662295736567, 0.412846515105, 33.9671867449, 0.0215211462877, 6565.8878, 0.829675710924, 71.9746111702, 55.352237541))
                    self.cars.append(individual.individual(154.897575174, 0.1979, 0.0725966428826, 0.816044271632, 94.0126932938, 0.828525310224, 0.271561863594, 33.9671867449, 0.135023495875, 5909.19902, 0.829675710924, 64.6771500532, 50.2293068554))
                    self.cars.append(individual.individual(154.897575174, 0.1979, -0.122420928551, 0.816044271632, 94.0126932938, 0.828525310224, 0.554131166615, 33.9671867449, 0.135023495875, 5909.19902, 0.829675710924, 64.6771500532, 50.2293068554))
                    self.cars.append(individual.individual(153.338599422, 0, 0.191774047647, 0.816044271632, 68.9638923345, 0.828525310224, 0.412846515105, 30.7883515863, 0.0215211462877, 6565.8878, 1.01264328202, 71.9746111702, 55.352237541))
                    self.cars.append(individual.individual(154.897575174, 0, 0.0834309524066, 0.816044271632, 76.7376581495, 0.662295736567, 0.384730869454, 30.7883515863, 0.0215211462877, 6565.8878, 0.829675710924, 79.2720722872, 55.352237541))
                    '''
