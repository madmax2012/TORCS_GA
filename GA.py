...
class RunGA():
    def __init__(self, rep_length, popsize, sp, mut, fitfun, maxgen, cross, nr_processes, run_id , path, onlyThebest, runval):
        ...
        if self.onlyTheBest == 1:
            ...
            #self.cars.append(individual.individual('154.897575174', '-0.0199', '-0.139884752072', '0.779904990626', '82.8097466274', '1.19039046912', '0.384730869454', '32.9286263315', '0.0215211462875', '5909.19902', '0.829675710924', '78.4693515643', '49.7170137868', '17.9086116398'))
            #total:1307.958time1: 99.03 time2: 198.36 time3: 139.2 time4: 132.908 time5: 121.922 time6: 95.55 time7: 60.486 time8: 152.806 time9: 130.45 time10: 177.246
            self.cars.append(individual.individual('154.897575174', '0.07811', '-0.0538732272792', '0.76210594072', '100.409793419', '1.19039046912', '0.246257782509', '23.7339685957', '-0.0806309683413', '5909.19902', '0.829675710924', '78.4693515643', '44.6453124081', '17.9086116398'))
