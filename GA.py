...
class gax(RunGA):
    ...
    def step(self):
       ...
       # print  "Driver:"+str(self.driver)
        ...
        print self.fitfun(['199.619642851', '0.526741925378', '19.6857890654', '0.597455592796', '61.3993866916', '0.621674369537', '0.903683282268', '18.4182020224', '0.113106885666'], 2)
