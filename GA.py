...
class RunGA():
    def __init__(self, rep_length, popsize, sp, mut, fitfun, maxgen, cross, nr_processes, run_id , path, onlyThebest, runval):
        ...
        if self.onlyTheBest == 1:
            ...
            self.cars.append(individual.individual('315.747854305', '0.358571129407', '12.3971542829', '-0.0233407536285', '18.4345487593', '0.400434704442', '0.607127139036', '1.04997944963', '1.1037209969'))
