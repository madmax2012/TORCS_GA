...
class RunGA():
    def __init__(self, rep_length, popsize, sp, mut, fitfun, maxgen, cross, nr_processes, run_id , path, onlyThebest, runval):
        ...
        if self.onlyTheBest == 1:
            ...
            self.cars.append(individual.individual('154.897575174', '-0.0199', '-0.139884752072', '0.779904990626', '82.8097466274', '1.19039046912', '0.246257782509', '29.5357636983', '0.123673260916', '5909.19902', '0.829675710924', '78.4693515643', '49.7170137868', '17.9086116398'))
