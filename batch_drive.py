...
def evaluation(parameters, ind):
    ...
    guiless=1
    if (guiless==1):
        server = subprocess.Popen(["torcs", "-t 10000000", "-r", fullpath + "/configs/" + str(port) + ".xml"])
    else:
